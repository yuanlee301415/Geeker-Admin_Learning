...
<template>
  <div class="card content-box assembly-box">
    ...
    <el-descriptions :column="1" title="配置项 📚" border>
      ...
      <el-descriptions-item label="toolbarConfig"
        >富文本 ToolBar区域 配置：
        <a href="https://www.wangeditor.com/v5/toolbar-config.html">https://www.wangeditor.com/v5/toolbar-config.html</a></el-descriptions-item
      >
      <el-descriptions-item label="editorConfig"
        >富文本 编辑区域 配置：
        <a href="https://www.wangeditor.com/v5/editor-config.html">https://www.wangeditor.com/v5/editor-config.html</a></el-descriptions-item
      >
    ...
    <el-dialog title="预览" v-model="visible" width="80vw" top="50px">
      <div v-html="content" style="height: 80vh" />
    </el-dialog>
  </div>
</template>
